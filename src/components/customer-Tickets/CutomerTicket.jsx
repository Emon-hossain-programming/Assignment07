...
const CutomerTicket = ({ticketsPromise,handleClick,task,removeHandle,resolveData}) => {
    ...
    return (
        <div className='grid md:grid-cols-12 grid-cols-1 mt-5 '>
            ...
            <div className='col-span-8  grid md:grid-cols-2 grid-cols-1 gap-3 mr-3 h-[850px]'>
                   {
                    tickets.map(ticket=><Ticket handleClick={handleClick} key={ticket.id} ticket={ticket}></Ticket>)
                   }
            </div>
            ...
            <div className='col-span-4  '>
                <div>
                    ...
                    <Task key={task.id} task={task} removeHandle={removeHandle}></Task> 
